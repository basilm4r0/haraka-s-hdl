...
struct	_vcs_dpi_rsrc_msg_struct	{
 ...
 extern void dpi_haraka_s(const /* INPUT */svOpenArrayHandle input_data, /* INPUT */long long input_len, const /* OUTPUT */svOpenArrayHandle output_data, /* INPUT */long long output_len);
